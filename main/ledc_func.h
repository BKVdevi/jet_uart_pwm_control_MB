...
#define MIN_PULSE_MS       500   // Минимальный импульс в микросекундах
#define MAX_PULSE_MS       2500   // Максимальный импульс в микросекундах
...
static void set_pwm_percent(int16_t value)
{
    ...
    uint16_t pulse_us = (MIN_PULSE_MS+(MAX_PULSE_MS-MIN_PULSE_MS)/2) + (value * ((MAX_PULSE_MS-MIN_PULSE_MS)/2)) / 100;
